...
public class SPKRealAdapter extends RecyclerView.Adapter<SPKRealAdapter.ListViewHolder> {

    private Context context;
    private List<SPK_REAL> list;

    public SPKRealAdapter(Context context, List<SPK_REAL> list) {
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        SPK_REAL spk = list.get(position);
